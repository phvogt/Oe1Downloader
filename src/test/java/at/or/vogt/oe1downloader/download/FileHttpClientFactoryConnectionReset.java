 ...
 */
public class FileHttpClientFactoryConnectionReset extends HttpClientFactory {
     ...
     */
    public FileHttpClientFactoryConnectionReset(final String responseFilename) {
    ...
    public CloseableHttpClient getHttpClient() {
        ...
        try {
            ...
            Mockito.when(result.execute((HttpGet) Mockito.any())).thenThrow(new SocketException("Connection reset"));
